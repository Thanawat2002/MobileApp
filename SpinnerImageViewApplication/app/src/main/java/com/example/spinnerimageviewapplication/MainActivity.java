package com.example.spinnerimageviewapplication;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btnSave) {
            ...
            Toast.makeText(this, "You select : " + inputs[pos2], Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long l) {
        ...
        if (id == R.id.spinner1) {
            pos1 = position;
            Toast.makeText(this, inputs[position], Toast.LENGTH_SHORT).show();
